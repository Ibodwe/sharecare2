...
public class GenerateQRCodeActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        text = this.getIntent().getStringExtra("QR_CONTENT");
        
        if(checkPermission()) generateQRCode(text);
        else
        {
    ...
    public void generateQRCode(String content)
    {
        ...
        try
        {
            Log.d("QRCodesComponent", content);
            Bitmap bitmap = createQRImage(content, size);
//            saveImageToExternalStorage(bitmap);
    ...
    private void saveImageToExternalStorage(Bitmap qrBitmap)
    {
    ...
    private void saveImageToDatabase(Bitmap qrBitmap)
    {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults)
    {
        ...
        {
            if(grantResults[0] == PackageManager.PERMISSION_GRANTED) generateQRCode(text);
            //else
            // ADD POPUP TEXT
    ...
    public Bitmap createQRImage(String text, int size) throws WriterException
    {
